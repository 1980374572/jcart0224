package io.bnn.jcartadministrationback.constant;
...
public class ClientExceptionConstant {
    ...
    public static final String ADMINISTRATOR_EMAIL_NOT_EXIST_ERRCODE = "0103";
    public static final String ADMINISTRATOR_EMAIL_NOT_EXIST_ERRMSG = "administrator email not esist errmsg";
}
